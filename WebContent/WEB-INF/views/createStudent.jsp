<%-- 
    ...
    Created on : 30-Nov-2020, 7:07:45 PM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>DAO Final Project Create Student</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">

    </head>
    <body class = "container">
        <header>
            <h1>DAO Final Project Create Student</h1>
        </header>
    ...
    <center><h3 class = "">You have chosen to make a new Student entry in the database</h3></center>
    <br>
    
    <c:url var="addAction" value='/CreateController/createStudent' ></c:url>
    
    <form:form action="${addAction}" method="POST" >
        <h5>Time to create a Student profile</h5>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="majorid" required placeholder="Criminology" name = "major">
            <div class="valid-feedback">Valid.</div>
            <div class="invalid-feedback">Please fill out this field.</div>
        </div>
